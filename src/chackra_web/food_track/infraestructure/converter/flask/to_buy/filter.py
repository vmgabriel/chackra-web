...
class FilterToBuyListFlaskHtml(shared_converter.AbstractConverter):
    ...
    def show_is_bought(value: bool) -> str:
        ...
        return markupsafe.Markup(
            """
            <select class="form-select" name="is_bought">
                <option value="" {selected_none}>Seleccione por ya comprado</option>
