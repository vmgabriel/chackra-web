...
"""
FIND_BY_EMAIL_QUERY = """
SELECT * FROM {table_name} WHERE email = %s AND enabled = false;
"""
FIND_BY_USERNAME_QUERY = """
SELECT * FROM {table_name} WHERE username = %s AND enabled = false;
"""
...
class PsycopgUserBaseFinderRepository(
    ...
    def find_by_username_and_email(self, username: str, email: str) -> shared_behavior.M | None:
