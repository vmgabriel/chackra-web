...
class SpecificationBuilder:
    ...
    converters_by_operator: dict[str, Callable[[str, Any], tuple[str, tuple]]]
    ...
    def build(self, attribute: str, operator: str, value: Any) -> shared_specifications.BaseSpecification:
